...
function getData(){
    $data[1]=$_POST['itemName'];
    $data=array();
    $data[2]=$_POST['purchasePrice'];
    $data[3]=$_POST['salePrice'];
    $data[4]=$_POST['governmentSalePrice'];
    return $data;
}
    
    if(isset($_POST['insert'])){
        $info=getData();
        $insert = "INSERT INTO inventory (item_name, purchase_price, sale_price, govt_sale_price) VALUES ('$info[1]', '$info[2]', '$info[3]', '$info[4]')";
...
<head>
    ...
    <style>
        ...
        /* Style for placeholder text in the search bar */
...
<body>
    ...
    <h1 class="title">SGS INVENTORY SYSTEM</h1>
    <div id="feedbackPopup"></div>
    <!-- Button to toggle the "Add Item" form -->

    <nav>
        <a href="#" onclick="toggleAddItemForm()">Add Item</a>
        <a href="#" onclick="document.getElementById('csvFileInput').click()">Load Data</a>
        <a href="#" onclick="downloadCSV()">Save Data</a>
        <a href="#" onclick="clearInventoryList()">Clear Data</a>
    </nav>
    ...
    <form id="addItemForm" style="display: none" method="POST" action="connect.php">
        <h2>Add/Edit Item</h2>
        ...
        <button type="button" id="saveButton" onclick="saveItem()" name="insert">Save Item</button>
        <button type="button" class="cancel" onclick="cancelAddEdit()">Cancel</button>
    </form>
    <h3>Search:</h3>
    <input type="text" id="searchBar" placeholder="Search by Item Name" oninput="searchItems()">
        ...
        function toggleItemDetails(item) {
            ...
            detailsDiv.innerHTML = `
                ...
                <table>
                    ...
                    <tr>
                        <td class="m">Government Sale Price</td>
